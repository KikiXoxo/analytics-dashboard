  ...
  return (
    <div className="transition duration-500 flex w-full h-16 p-8 justify-between items-center border-b border-b-[#E5EAEF] dark:border-b-gray-600">
      ...
      <div className="flex gap-4 justify-between items-center">
        ...
        <div className="border dark:border-gray-400 rounded-full flex justify-center p-2">
          <img src={bell} alt="" />
        </div>

        <div className="flex gap-2 px-1.5 py-1 border rounded-3xl dark:border-gray-700">
